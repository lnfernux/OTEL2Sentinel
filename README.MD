...
`-DcrResourceId` is how the script finds the workspace your telemetry lands in. `-LogAnalyticsWorkspaceName` points at the workspace behind Container App console logs, which never receives agent telemetry.
